    ...
    for config_key in extract_domain_configs(config, DOMAIN):
        ...
        for list_no, config_block in enumerate(conf):
            ...
            if CONF_CONDITION in config_block:
                condition = _process_if(hass, config, config_block)
            ...
            entity = AutomationEntity(name, attach_triggers, condition, action)
...
class AutomationEntity(ToggleEntity):
    ...
    def __init__(self, name, attach_triggers, condition, action):
        self._name = name
